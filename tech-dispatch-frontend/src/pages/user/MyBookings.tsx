...
import type { SocketBookingUpdatePayload } from "../../types";
...
export default function MyBookings() {
  ...
  const { bookings, fetchBookings, cancelBooking, rateBooking, updateBookingStatus, loading } = useBookingStore();
  ...
  }, [isAuthenticated, user, updateBookingStatus]);
